...
public class DumpLog {
    ...
    private String logFilePath = "DUMP_TestCaseName.log";
    ...
    public DumpLog(String testCaseName) {
    ...
    public static synchronized DumpLog getInstance() {

        if (instance == null) {
            synchronized (DumpLog.class) {
                if (instance == null)
                    instance = new DumpLog("default");
            }
        }
        return instance;
    }

    public static synchronized DumpLog getInstance(String testCaseName) {

        if (instance == null) {
            synchronized (DumpLog.class) {
                if (instance == null)
                    instance = new DumpLog(testCaseName);
            }
        }
        return instance;
    }
